...
export default function SignUpScreen() {
  ...
  return (
    <View style={Colors} className="flex-1 bg-[--bg-color] items-center justify-center px-6">
      ...
      <Button className='mb-4' onPress={handelSubmit}>Create Account!</Button>
      <TouchableOpacity onPress={()=>{
        router.push("/auth/signIn")
      }}>
        <Text className="text-[--secondary-color] border-b border-[--secondary-color]">Already have an account? Sign In</Text>
      </TouchableOpacity>
    </View>
  );
}
